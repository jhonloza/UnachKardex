...
public class FormBCategorias  {
    ...
    public FormBCategorias() {
        ...
        nombre = new Label();
        nombre.setMaxSize(175, 25);
        nombre.setMinSize(175, 25);
        nombre.setStyle("-fx-border-color: mediumblue; -fx-border-width: 2px");
        descripcion = new Label();
        descripcion.setMaxSize(175, 25);
        descripcion.setMinSize(175, 25);
